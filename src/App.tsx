...
// Лапка «Лапки»: коралл из логотипа
const PawIcon = ({ size = 28 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="#DB7B75" aria-hidden="true">
    <ellipse cx="13" cy="15" rx="5" ry="6.5" />
    <ellipse cx="24" cy="10" rx="5" ry="6.5" />
    <ellipse cx="35" cy="15" rx="5" ry="6.5" />
    <ellipse cx="7" cy="27" rx="4.2" ry="5.5" transform="rotate(-20 7 27)" />
    <ellipse cx="41" cy="27" rx="4.2" ry="5.5" transform="rotate(20 41 27)" />
    <path d="M24 22c-7 0-13 6-13 12.5 0 4 3 6.5 6.5 6.5 2.5 0 4.5-1.2 6.5-1.2s4 1.2 6.5 1.2c3.5 0 6.5-2.5 6.5-6.5C37 28 31 22 24 22z" />
  </svg>
);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="handnote absolute left-4 md:left-7 top-[30%] md:top-[92px] z-10 max-w-[210px] md:max-w-none md:whitespace-nowrap">{c.hero.note}</span>
      </MaskedCard>
    </section>
  );
}
    ...
    >
      <div className="flex-1 min-h-0 grid grid-cols-1 md:grid-cols-2 grid-rows-[auto_auto_auto_auto] md:grid-rows-[1fr_1fr_0.8fr] gap-1.5 md:gap-2">
        ...
        >
          ...
          <span className="handnote absolute bottom-4 left-5 md:bottom-6 md:left-7 z-10">{c.gallery.note}</span>
        </MaskedCard>
  ...
  return (
    <footer id="contacts" className="w-full px-3 md:px-5 pt-6 md:pt-8 pb-24 md:pb-28 scroll-mt-20 md:scroll-mt-24">
      <div className="rounded-xl md:rounded-2xl bg-stone-50 p-5 md:p-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <div className="flex items-center gap-3 text-3xl md:text-4xl font-extrabold uppercase tracking-tight leading-none">
            <PawIcon size={44} />
            <span>
              {c.clinic.logoTop}
              {c.clinic.logoBottom && (
